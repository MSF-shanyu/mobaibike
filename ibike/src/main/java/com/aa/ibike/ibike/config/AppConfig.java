package com.aa.ibike.ibike.config;
...
public class AppConfig {
	...
	public RedisTemplate redsiTemplate() {
        ...
        conn.setDatabase(0);
        conn.setHostName("192.168.234.204");
        conn.setPort(6379);
        conn.setPassword("");
...
//    	ServerAddress sa1=new ServerAddress("192.168.234.200",23000);
//    	ServerAddress sa2=new ServerAddress("192.168.234.201",23000);
//    	ServerAddress sa3=new ServerAddress("192.168.234.202",23000);
//    	list.add( sa1 );
//    	list.add( sa2 );
//    	list.add( sa3 );
//    	
...
//    }
    ...
    @Bean("mongoClient")
    public MongoClient client() {
        return new MongoClient("192.168.234.204", 27017);
    }
	...
	public  DriverManagerDataSource   dataSource(       ) {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/mybike");
