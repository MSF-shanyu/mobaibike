package com.aa.ibike.ibike.utils;
...
public class SmsSendUtil {
	...
	public static String sendSms(String valcode, String[] phoneNumbers) {
		try {
			...
			Credential cred = new Credential(SmsConstants.SMSSECREID, SmsConstants.SMSSECREKEY);
			...
			req.setSmsSdkAppid(SmsConstants.SMSSDKAPPID);

			/* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
			req.setSign(SmsConstants.SMSSIGN);
			...
			req.setTemplateID(SmsConstants.SMSTEMPLATEID);
